...
import education.LessonStudentComands;
import education.UserComands;
import education.model.Lesson;
import education.model.Student;
import education.model.User;
import education.storage.LessonStorage;
import education.storage.StudentStorage;
import education.storage.UserStroage;
...
import static education.LessonStudentComands.*;
import static education.UserComands.LOGIN;
import static education.UserComands.REGISTER;

public class LessonStudentTest {
    static StudentStorage studentStorage = new StudentStorage();
    static UserStroage userStorage = new UserStroage();
    ...
    private static void initeData() {
        lessonStorage.initeData();
        studentStorage.initeData();
        userStorage.initeData();
    }
    ...
    private static void register() {
        ...
        if (byEmail == null) {
            ...
            System.out.println("est takoy email");
        }
    ...
    private static void addStudent() {
        ...
        for (int i = 0; i < lessonNames.length; i++) {
            if (lessonStorage.getByLessonName(lessonNames[i]) != null) {
                ...
                lessons = new HashSet<>(Arrays.asList(lessonStorage.getByLessonName(lessonNames[i])));
